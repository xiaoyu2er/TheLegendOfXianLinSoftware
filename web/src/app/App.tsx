...
export function App() {
  ...
  const onBattleMouse = (e: 'press' | 'move') => (event: ReactMouseEvent<HTMLDivElement>) => {
    ...
    if (e === 'press') grabRelease(box, (p) => view.battleMouse({ e: 'release', ...p }))
  }
